...
import { getGtViewSpecs, GtViewSpec } from '../queries/getGtViewSpecs';
...
describe('getGtViewSpecs', () => {
  ...
  it('returns null when execute returns a GtError string', () => {
    expect.assertions(1);
    const execute = vi.fn(() => 'GtError:does not understand #getInspectorSpecificationData');
