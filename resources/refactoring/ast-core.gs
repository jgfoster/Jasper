! Vendored AST substrate for Jasper refactoring tools (grail #62)
! ============================================================================
! GENERATED FILE - DO NOT EDIT BY HAND.
! Regenerated by docs/refactoringSupport/build-ast-payload.sh from the verbatim
! Tonel under gs-src/refactoring/vendor/rowanv3-ast/ (tonel-to-gs.js).
!
